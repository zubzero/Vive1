cordova.define("cordova-plugin-googlemaps.BaseClass", function(require, exports, module) { var VARS_FIELD = typeof Symbol === 'undefined' ? '__vars' + Date.now() : Symbol.for('vars');
